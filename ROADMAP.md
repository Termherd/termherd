...
### <a id="f-packaging-ci"></a>F-packaging-ci
...
### <a id="f-quality-gates"></a>F-quality-gates
...
### <a id="f-app-shell"></a>F-app-shell
...
### <a id="f-builtin-terminal"></a>F-builtin-terminal
...
### <a id="f-close-confirm-policy"></a>F-close-confirm-policy
...
### <a id="f-plans-memory"></a>F-plans-memory
...
### <a id="f-session-browser"></a>F-session-browser
...
### <a id="f-session-metadata"></a>F-session-metadata
...
### <a id="f-session-tabs"></a>F-session-tabs
...
### <a id="f-status-notifications"></a>F-status-notifications
...
### <a id="f-antigravity-sessions"></a>F-antigravity-sessions
...
### <a id="f-auto-update"></a>F-auto-update
...
### <a id="f-fork-detection"></a>F-fork-detection
...
### <a id="f-jsonl-viewer"></a>F-jsonl-viewer
...
### <a id="f-store-cache"></a>F-store-cache
...
### <a id="f-terminal-images"></a>F-terminal-images
...
### <a id="f-terminal-split"></a>F-terminal-split
...
### <a id="f-close-on-exit"></a>F-close-on-exit
...
### <a id="f-activity-stats"></a>F-activity-stats
...
### <a id="f-file-browser"></a>F-file-browser
...
### <a id="f-launch-profiles"></a>F-launch-profiles
...
### <a id="f-mcp-agent-loop"></a>F-mcp-agent-loop
...
### <a id="f-mcp-control-surface"></a>F-mcp-control-surface
...
### <a id="f-mcp-ide-bridge"></a>F-mcp-ide-bridge
...
### <a id="f-multi-window"></a>F-multi-window
...
### <a id="f-repo-view"></a>F-repo-view
...
### <a id="f-scheduled-tasks"></a>F-scheduled-tasks
...
### <a id="f-session-accent-colors"></a>F-session-accent-colors
...
### <a id="f-session-grid"></a>F-session-grid

A layout preset over the pane model.

A layout preset over the pane model

### <a id="f-mcp-config-write"></a>F-mcp-config-write
...
### <a id="f-mcp-live-bridge"></a>F-mcp-live-bridge
...
### <a id="f-mcp-orchestration"></a>F-mcp-orchestration
...
### <a id="f-mcp-screenshot"></a>F-mcp-screenshot
...
### <a id="f-mcp-snapshot"></a>F-mcp-snapshot
...
### <a id="f-mcp-snapshot-g1"></a>F-mcp-snapshot-g1
...
### <a id="f-mcp-terminal-sync"></a>F-mcp-terminal-sync
...
### <a id="f-terminal-palette"></a>F-terminal-palette
...
### <a id="f-keymap-advanced"></a>F-keymap-advanced
...
### <a id="f-search-ux"></a>F-search-ux
...
### <a id="f-favorites"></a>F-favorites
...
### <a id="f-file-diff-panel"></a>F-file-diff-panel
